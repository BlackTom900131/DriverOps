...
class StatusScreen extends ConsumerWidget {
  ...
  String _labelFor(DriverStatus status) {
    return switch (status) {
      DriverStatus.none => tr('status.none'),
      DriverStatus.pending => tr('status.pending'),
      DriverStatus.underVerification => tr('status.under_verification'),
      DriverStatus.approved => tr('status.approved'),
      DriverStatus.rejected => tr('status.rejected'),
      DriverStatus.suspended => tr('status.suspended'),
    };
  }
